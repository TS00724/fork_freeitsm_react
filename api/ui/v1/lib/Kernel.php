...
final class UiApiKernel
{
    ...
    /** Create/handle a request while containing request-construction errors. */
    ...
    private function logUnexpected(Throwable $error, UiApiRequest $request, UiApiRequestContext $context): void
    {
