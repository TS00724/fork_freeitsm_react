...
require_once __DIR__ . '/UiApiLegacyActor.php';
...
{
    return new UiApiSecurityRuntime(
        new UiApiNativeSessionStore(),
        new UiApiLegacySecurityProvider(),
        new UiApiCsrfGuard()
    );
}

/** @param UiApiRoute[]|null $routes */
function uiApiBuildKernel(
    ?array $routes = null,
    ?UiApiSecurityRuntime $security = null
): UiApiKernel {
