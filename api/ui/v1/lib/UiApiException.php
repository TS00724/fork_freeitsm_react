...
final class UiApiException extends RuntimeException
{
    ...
    public static function csrfFailed(string $message): self { return new self(403, 'csrf_failed', $message); }
    public static function csrfOriginFailed(): self { return new self(403, 'csrf_origin_failed', 'The request origin is not accepted.'); }
    ...
    public static function passwordChangeRequired(?string $url = null): self
    {
        ...
        return new self(403, 'password_change_required', 'The password must be changed before continuing.', $details);
    }
