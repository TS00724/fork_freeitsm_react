...
final class UiApiRouteSecurity
{
    ...
    public static function publicRoute(): self
    {
        return new self(false, false, false, false);
    }

    public static function sessionProbe(): self
    {
        return new self(false, true, false, true);
    }

    public static function authenticated(bool $issueCsrf = false): self
    {
        return new self(true, false, false, $issueCsrf);
    }

    public static function authenticatedWrite(): self
    {
