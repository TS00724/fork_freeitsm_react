...
final class UiApiSecurityRuntime
{
    ...
    public function authorize(
        ...
        // Fail CSRF before any database-backed actor, tenant or RBAC lookup.
        if ($policy->csrfRequired()) {
            $this->csrf->validate($request, $this->session);
        }
