...
{
    public function success($data, UiApiRequestContext $context, int $status = 200, ?array $additionalMeta = null): UiApiHttpResponse
    {
        ...
        return new UiApiHttpResponse($status, $this->headers($context), $this->encode(['data' => $data, 'meta' => $meta]));
    }
    ...
    {
        return $this->error(new UiApiException(500, 'server_error', 'An unexpected server error occurred.'), $context);
    }
