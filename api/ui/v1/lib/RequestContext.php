 ...
 *
 * WP-04 resolves only transport metadata. Actor, tenant, capabilities, locale
 * and timezone remain explicit null slots until WP-05 binds authoritative
 * PHP-Session and database state.
 */
final class UiApiRequestContext
{
    ...
    /** Build fallback metadata even when request-path parsing itself fails. */
